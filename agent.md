...
4. Write any other new code the PRD requires that no feature covers. Group changes into focused commits via `commit_to_solution(persona='builder', iteration, subject, files)`.
